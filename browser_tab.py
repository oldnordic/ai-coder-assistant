# browser_tab.py
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLineEdit, QPushButton, QGroupBox, QFormLayout, QTextEdit, QLabel, QProgressBar)
...
def setup_browser_tab(parent_widget, main_app_instance):
    ...
    # If browser_profile is needed, it should be handled in main_window
    ...
    main_app_instance.transcription_status_label = QLabel("Ready")
    main_app_instance.transcription_progressbar = QProgressBar()
    main_app_instance.transcription_progressbar.setValue(0)
    main_app_instance.transcription_progressbar.setTextVisible(True)
    ...
    transcription_layout.addRow("Status:", main_app_instance.transcription_status_label)
    transcription_layout.addRow("Progress:", main_app_instance.transcription_progressbar)
