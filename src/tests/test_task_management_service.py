...
class TestTaskManagementService:
    ...
    def test_create_task_success(
            self, task_service: TaskManagementService, sample_task_data: Dict[str, Any]):
    ...
    def test_complete_task(self, task_service: TaskManagementService,
    ...
    def test_data_validation(self, task_service: TaskManagementService):
        ...
        # Test with empty title - this should work as the service doesn't validate
        # empty titles
        task = task_service.create_task(
            title="",
            description="Test",
        ...
        # Test with empty assignee - this should work as the service doesn't
        # validate empty assignees
        task = task_service.create_task(
            title="Test",
            description="Test",
            assignee=""
