...
class WebServerService:
    ...
    async def handle_realtime_analysis(self, message: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"type": "analysis_result", "success": True, "result": result}
        except Exception as e:
            return {"type": "analysis_result", "success": False, "error": str(e)}
    ...
    def start_server(self):
        ...
        logger.info(
            f"Web server started on http://{self.config.host}:{self.config.port}"
        )
