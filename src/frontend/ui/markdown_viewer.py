...
class MarkdownViewerDialog(QDialog):
    ...
    def display_markdown(self):
        ...
        try:
            ...
            html_content = markdown.markdown(
                self.markdown_content, extensions=["fenced_code", "tables", "nl2br"]
            )

            # Set the HTML content
            self.text_browser.setHtml(html_content)
        except Exception as e:
            QMessageBox.critical(self, "Error", f"Failed to render markdown: {str(e)}")
    ...
    def save_as_txt(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "Error", f"Failed to save text file: {str(e)}")
    ...
    def save_as_pdf(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "Error", f"Failed to save PDF file: {str(e)}")
    ...
    def save_as_html(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "Error", f"Failed to save HTML file: {str(e)}")
